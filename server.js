...
let devicesConfig = { "device003": "192.168.1.181", "device004": "192.168.1.182", "device002": "192.168.0.20" };
...
const app = express();
app.listen(8000, () => console.log("Servidor web iniciado en el puerto 8000"));
